...
void head(void){
    printf("%20s %9s %10s %10s %9s %10s", "Surname", "CPU count", "CPU type", "RAM memory", "GPU type", "GPU memory");
    printf("%10s %10s %9s %11s %11s %20s\n", "HDD type", "HDD memory", "HDD count", "dcs control", "bit control", "OC");
}
